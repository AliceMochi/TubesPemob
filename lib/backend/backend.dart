...
import 'schema/deliver_record.dart';
...
export 'schema/deliver_record.dart';
...
/// Functions to query DeliverRecords (as a Stream and as a Future).
Future<int> queryDeliverRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DeliverRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DeliverRecord>> queryDeliverRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<DeliverRecord>> queryDeliverRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<DeliverRecord>> queryDeliverRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
